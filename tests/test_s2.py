...
def test_polyfill():
    ...
    data_test = yaml.load(
        open("tests/test_data/polyfill_tests.yaml"), Loader=yaml.SafeLoader
    )
    ...
    # assert (
    #     s2.polyfill(data_test["boundary"], 10, True, True)
